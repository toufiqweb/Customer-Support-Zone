...
const TaskStatus = ({
  ...
  return (
    <div className="group bg-white shadow-sm hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 ease-out rounded-3xl overflow-hidden border border-gray-100 hover:border-green-200">
      <div className="card-body p-4 lg:p-8 items-center text-center">
      ...
      <div className="h-1.5 bg-linear-to-r from-green-400 to-emerald-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
    </div>
  );
};
